...
router.get('/:iduser/:fwcloud/:idfirewall/:type', function (req, res)
{
...
router.post("/policy-type/:iduser/:fwcloud/:idfirewall/", function (req, res)
{
...
router.put('/policy-type//:iduser/:fwcloud/:idfirewall/', function (req, res)
{
...
/* Remove policy_type */
router.delete("/policy-type/:iduser/:fwcloud/:idfirewall", function (req, res)
{
