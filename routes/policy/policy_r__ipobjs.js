...
router.post("/policy-r__ipobj/:idfirewall",
...
router.put('/policy-r__ipobj/:idfirewall/:rule/:position/:negate',
utilsModel.checkFirewallAccess,  
utilsModel.disableFirewallCompileStatus,
(req, res) => {
	var rule = req.params.rule;
...
router.put('/policy-r__ipobj/:idfirewall/:rule/:ipobj/:ipobj_g/:interface/:position/:position_order/:new_order',
utilsModel.checkFirewallAccess,  
utilsModel.disableFirewallCompileStatus,
(req, res) => {
	var rule = req.params.rule;
...
router.put("/del/policy-r__ipobj/:idfirewall/:rule/:ipobj/:ipobj_g/:interface/:position/:position_order",
utilsModel.checkFirewallAccess, 
utilsModel.disableFirewallCompileStatus,
(req, res) => {
