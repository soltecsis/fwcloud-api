...
INSERT INTO `ipobj_type__policy_position` VALUES (5,1),(6,1),(7,1),(8,1),(10,1),(11,1),(20,1),(311,1),(400,1),(5,2),(6,2),(7,2),(8,2),(10,2),(11,2),(20,2),(311,2),(400,2),(1,3),(2,3),(3,3),(4,3),(21,3),(5,4),(6,4),(7,4),(8,4),(10,4),(11,4),(20,4),(311,4),(400,4),(5,5),(6,5),(7,5),(8,5),(10,5),(11,5),(20,5),(311,5),(400,5),(1,6),(2,6),(3,6),(4,6),(21,6),(5,7),(6,7),(7,7),(8,7),(10,7),(11,7),(20,7),(311,7),(400,7),(5,8),(6,8),(7,8),(8,8),(10,8),(11,8),(20,8),(311,8),(400,8),(1,9),(2,9),(3,9),(4,9),(21,9),(5,11),(6,11),(7,11),(8,11),(10,11),(11,11),(20,11),(311,11),(400,11),(5,12),(6,12),(7,12),(8,12),(10,12),(11,12),(20,12),(311,12),(400,12),(1,13),(2,13),(3,13),(4,13),(21,13),(5,14),(6,14),(311,14),(400,14),(2,16),(4,16),(10,20),(10,21),(10,22),(10,24),(10,25),(5,30),(6,30),(7,30),(8,30),(10,30),(11,30),(20,30),(311,30),(400,30),(5,31),(6,31),(7,31),(8,31),(10,31),(11,31),(20,31),(311,31),(400,31),(1,32),(2,32),(3,32),(4,32),(21,32),(5,34),(6,34),(311,34),(400,34),(2,35),(4,35),(10,36);
...
--
-- Table structure for table `policy_r__prefix`
--

DROP TABLE IF EXISTS `policy_r__prefix`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `policy_r__prefix`
--

LOCK TABLES `policy_r__prefix` WRITE;
/*!40000 ALTER TABLE `policy_r__prefix` DISABLE KEYS */;
/*!40000 ALTER TABLE `policy_r__prefix` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `fwcloud`.`policy_r__prefix_AFTER_INSERT` AFTER INSERT ON `policy_r__prefix` FOR EACH ROW
BEGIN
	call update__rule_ts(NEW.rule);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `fwcloud`.`policy_r__prefix_AFTER_UPDATE` AFTER UPDATE ON `policy_r__prefix` FOR EACH ROW
BEGIN
	call update__rule_ts(NEW.rule);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `fwcloud`.`policy_r__prefix_AFTER_DELETE` AFTER DELETE ON `policy_r__prefix` FOR EACH ROW
BEGIN
	call update__rule_ts(OLD.rule);
END */;;
DELIMITER ;
...
CREATE TABLE `prefix` (
  ...
  KEY `idx_ca` (`ca`),
  CONSTRAINT `fk_prefix-ca` FOREIGN KEY (`ca`) REFERENCES `ca` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
