...
$IPTABLES -A FWCRULE818.CH1 -d 224.0.0.13 -j FWCRULE818.CH2
$IPTABLES -A FWCRULE818.CH1 -d 10.98.0.254 -j FWCRULE818.CH2
$IPTABLES -A FWCRULE818.CH2 -s 2.2.2.2 -j FWCRULE818.CH3
...
# varias líneas
# 
$IPTABLES -N FWCRULE796.CH4
$IPTABLES -N FWCRULE796.CH3
$IPTABLES -N FWCRULE796.CH2
$IPTABLES -N FWCRULE796.CH1
$IPTABLES -A FORWARD -i eth1 -m state --state NEW -j FWCRULE796.CH1
$IPTABLES -A FWCRULE796.CH1 -o tun20 -j FWCRULE796.CH2
$IPTABLES -A FWCRULE796.CH1 -o eth0 -j FWCRULE796.CH2
$IPTABLES -A FWCRULE796.CH2 -p tcp --dport 8081 -j FWCRULE796.CH3
$IPTABLES -A FWCRULE796.CH2 -p udp --dport 514 -j FWCRULE796.CH3
$IPTABLES -A FWCRULE796.CH3 -s 10.98.1.254 -j FWCRULE796.CH4
$IPTABLES -A FWCRULE796.CH3 -s 10.0.0.5 -j FWCRULE796.CH4
$IPTABLES -A FWCRULE796.CH4 -d 10.99.4.0/255.255.255.0 -j ACCEPT
$IPTABLES -A FWCRULE796.CH4 -d 10.0.0.5 -j ACCEPT

echo "RULE 46 (ID: 807)"
# Proveta de comentari
$IPTABLES -N FWCRULE807.CH1
$IPTABLES -A FORWARD -i eth1 -p udp --dport 514 -d 9.9.9.9 -m state --state NEW -j FWCRULE807.CH1
$IPTABLES -A FWCRULE807.CH1 -s 10.10.10.11 -j DENY
$IPTABLES -A FWCRULE807.CH1 -s 46.24.15.81 -j DENY
$IPTABLES -A FWCRULE807.CH1 -s null -j DENY
