...
echo "RULE 4 (ID: 761)"
$IPTABLES -N FWCRULE761.CH2
$IPTABLES -N FWCRULE761.CH1
$IPTABLES -A INPUT -d 10.98.1.254 -m state --state NEW -j FWCRULE761.CH1
$IPTABLES -A FWCRULE761.CH1 -p tcp --dport 11941 -j FWCRULE761.CH2
$IPTABLES -A FWCRULE761.CH1 -p udp --dport 11941 -j FWCRULE761.CH2
$IPTABLES -A FWCRULE761.CH2 -i eth1 -j ACCEPT
$IPTABLES -A FWCRULE761.CH2 -i eth0 -j ACCEPT
...
echo "RULE 10 (ID: 764)"
$IPTABLES -N FWCRULE764.CH1
$IPTABLES -A INPUT -p tcp -m multiport --dports 445,80,8080,443 -s 10.99.4.0/255.255.255.0 -m state --state NEW -j FWCRULE764.CH1
$IPTABLES -A FWCRULE764.CH1 -d 10.98.0.0/255.255.255.0 -j ACCEPT
$IPTABLES -A FWCRULE764.CH1 -d 10.98.1.255 -j ACCEPT

echo "RULE 11 (ID: 765)"
# Regla temporal para configurar el nuevo nodo ESX de Gestimed.
$IPTABLES -A INPUT -i eth0 -p tcp --dport 21 -s 0.0.0.0 -d 0.0.0.0 -m state --state NEW -j ACCEPT
...
echo "RULE 19 (ID: 774)"
# Regla temporal para configurar el nuevo nodo ESX de Gestimed.
$IPTABLES -A INPUT -i eth1 -s 0.0.0.0 -d 0.0.0.0 -m state --state NEW -j ACCEPT
...
$IPTABLES -A INPUT -i eth1 -s 10.98.1.0/255.255.255.0 -d 0.0.0.0 -m state --state NEW -j ACCEPT
...
$IPTABLES -A FWCRULE777.CH1 -p tcp -m multiport --dports 22,873,445,5001,3300 -j FWCRULE777.CH2
...
$IPTABLES -A FORWARD -i eth1 -s 10.98.1.254 -m state --state NEW -j FWCRULE796.CH1
...
$IPTABLES -A FWCRULE796.CH3 -d 10.0.0.5 -j ACCEPT
...
$IPTABLES -A FWCRULE807.CH1 -d 9.9.9.9 -j FWCRULE807.CH2
$IPTABLES -A FWCRULE807.CH1 -d 224.0.0.1 -j FWCRULE807.CH2
$IPTABLES -A FWCRULE807.CH2 -s 10.10.10.11 -j DENY
$IPTABLES -A FWCRULE807.CH2 -s 46.24.15.81 -j DENY
$IPTABLES -A FWCRULE807.CH2 -s null -j DENY
...
$IPTABLES -A FWCRULE809.CH1 -s 10.99.2.0/255.255.255.0 -j REJECT
