...
export class FwCloudExportService extends Service {
    ...
    public async create(fwCloud: FwCloud, user: User, ttl: number = 0, eventEmitter: EventEmitter = new EventEmitter()): Promise<FwCloudExport> {
    ...
    public async import(filePath: string, user: User, eventEmitter: EventEmitter = new EventEmitter()): Promise<FwCloud> {
