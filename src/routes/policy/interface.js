...
router.put('/move', utilsModel.disableFirewallCompileStatus, async (req, res) => {
  ...
  try {
    ...
    } else if (psts.content1 === 'O' && psts.content2 === 'I') {
      //DIFFERENTS POSITIONS CONTENT TYPE
...
router.put('/order', utilsModel.disableFirewallCompileStatus, (req, res) => {
  ...
  PolicyRuleToInterface.updatePolicy_r__interface_order(
    rule,
    interfaceName,
    position,
    old_order,
