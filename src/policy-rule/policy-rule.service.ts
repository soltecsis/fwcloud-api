...
export class PolicyRuleService extends Service {
    ...
    public async compile(fwcloudId: number, firewallId: number, channel?: EventEmitter): Promise<void> {
    ...
    protected getPolicyScript(fwcloudId: number, firewallId: number, channel?: EventEmitter): PolicyScript {
