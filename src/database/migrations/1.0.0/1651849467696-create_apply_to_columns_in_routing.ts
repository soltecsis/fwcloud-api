...
export class createApplyToColumnsInRouting1651849467696 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createForeignKey('routing_r', new TableForeignKey({
        ...
        await queryRunner.createForeignKey('route', new TableForeignKey({
            columnNames: ['fw_apply_to'],
            referencedTableName: 'firewall',
            referencedColumnNames: ['id']
        })); 
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        const foreignKey_table_routing_r = table_routing_r.foreignKeys.find(fk =>fk.columnNames.indexOf('fw_apply_to') !== -1);
        ...
        const foreignKey_table_route = table_route.foreignKeys.find(fk =>fk.columnNames.indexOf('fw_apply_to') !== -1);
