...
export class addOpenvpnStatusHistoryIndexes1669884249679 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("set FOREIGN_KEY_CHECKS=0; ALTER TABLE openvpn_status_history DROP INDEX IDX_adba662cf32738c010d418fda8; set FOREIGN_KEY_CHECKS=1;");
    }
