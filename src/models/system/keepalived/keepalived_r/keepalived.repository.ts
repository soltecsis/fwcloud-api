...
export class KeepalivedRepository extends Repository<KeepalivedRule> {
  ...
  async findManyInPath(
    path: IFindManyKeepalivedRPath,
    options?: FindManyOptions<KeepalivedRule>,
  ...
  async move(
    ...
    if (offset === Offset.Above) {
      ...
      affectedKeepaliveds = await this.moveBelow(
        keepalived_rs,
        affectedKeepaliveds,
        destkeepalived,
      );
  ...
  ): FindOneOptions<KeepalivedRule> | FindManyOptions<KeepalivedRule> {
