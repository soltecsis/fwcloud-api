...
export class DHCPRepository extends Repository<DHCPRule> {
   ...
   */
  async findManyInPath(
    path: IFindManyDHCPRPath,
    options?: FindManyOptions<DHCPRule>,
  ): Promise<DHCPRule[]> {
  ...
  protected getFindInPathOptions(
    path: Partial<IFindOneDHCPRPath>,
    options: FindOneOptions<DHCPRule> | FindManyOptions<DHCPRule> = {},
  ): FindOneOptions<DHCPRule> | FindManyOptions<DHCPRule> {
