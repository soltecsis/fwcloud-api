...
export class Customer extends Model {
    ...
    public static existsName = (dbCon, name) => {
        return new Promise(async (resolve, reject) => {
            dbCon.query(`select id from ${tableName} where name=${dbCon.escape(name)}`, (error, result) => {
                if (error) return reject(error);
    ...
    public static lastCustomer(req) {
        return new Promise((resolve, reject) => {
            req.dbCon.query(`select count(*) as n from ${tableName} where id!=${req.body.customer}`, async (error, result) => {
                if (error) return reject(error);
