...
import { Boolean } from "../../fonaments/validation/rules/boolean.rule";
...
export class RouteController extends Controller {
    ...
    @Validate({
        routeGroupId: [new Number()],
        gatewayId: [new Number(), new Required()],
        interfaceId: [new Number()],
        active: [new Boolean()],
        comment: [new String()]
    })
