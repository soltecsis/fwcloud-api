...
var errorTable = {
  ...
  MODULE_NOT_FOUND: {
    fwcErr: 2005,
    msg: 'This Express route is not controlled in the input data validation process',
  },
  BAD_BODY_TYPE: { fwcErr: 2006, msg: 'Bad value in req.body.type' },
  SCR_PORT_1: {
    fwcErr: 2007,
    msg: 'Source port end must be greater or equal than source port start',
  },
  DST_PORT_1: {
    fwcErr: 2008,
    msg: 'Destination port end must be greater or equal than destination port start',
  },
  ONLY_ONE_NOT_NEGATIVE: {
    fwcErr: 2009,
    msg: 'Only one of ipob, ipobj_g and interface must different from -1',
  },
  ...
  IF_TO_IPOBJ_GROUP: {
    fwcErr: 4001,
    msg: 'It is not possible to add network interfaces to IP objects groups',
  },
  ...
  SSH_COMMUNICATION_DISABLE: {
    fwcErr: 9000,
    msg: 'Communication by means of SSH is forbidden in the API',
  },
};
