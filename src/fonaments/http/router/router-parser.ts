...
export class RouterParser {
  ...
  protected newControllerHandler(
    ...
    if (FunctionHelper.isCallback(controller)) {
      this._currentRoute = this.buildCallbackHandler(
        httpMethod,
        pathParams,
        this._gates,
        <RequestHandlerCallback>controller,
      );
      return this._currentRoute;
    }

    this._currentRoute = this.buildControllerHandlerRoute(
      httpMethod,
      pathParams,
      this._gates,
      <typeof Controller>controller,
      method,
    );
    return this._currentRoute;
  }
  ...
  protected buildCallbackHandler(
    httpMethod: HttpMethod,
    pathParams: PathParams,
    gates: Array<typeof Gate>,
  ...
  protected buildControllerHandlerRoute(
    httpMethod: HttpMethod,
    pathParams: PathParams,
    gates: Array<typeof Gate>,
    controller: typeof Controller,
