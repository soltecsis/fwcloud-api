...
## [2.5.7] - 2026-08-26
### Fixed
- Allow Suricata activation on cluster nodes when the selected network interface is defined on the cluster master.
...
## [2.1.5] - 2025-09-17
### Fixed
- OpenVPN over SSH block/sync/install/uninstall actions do not work.
- Axios NPM package vulnerability.
