...
describe(describeName('Firewall E2E Tests'), () => {
  ...
  describe('@compileDhcpRules', () => {
    ...
    beforeEach(async () => {
      ...
      rule1 = await getRepository(DHCPRule).save(
      ...
      rule2 = await getRepository(DHCPRule).save(
        getRepository(DHCPRule).create({
          rule_order: 2,
          interface: null,
          rule_type: 1,
  ...
  describe('@compileHAProxyRules', () => {
    ...
    beforeEach(async () => {
      ...
      rule1 = await getRepository(HAProxyRule).save(
      ...
      rule2 = await getRepository(HAProxyRule).save(
        getRepository(HAProxyRule).create({
          rule_type: 1,
          firewall: firewall,
          frontendIp: await getRepository(IPObj).save(
