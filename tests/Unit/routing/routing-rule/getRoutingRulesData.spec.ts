  ...
  describe('For grid', () => {
    ...
    describe('Out of group', () => {
      ...
      it('should include address data', async () => {
        ...
        item.host_name = null;
        item._order = (
          await getRepository(RoutingRuleToIPObj).findOneOrFail({
            where: {
      ...
      it('should include OpenVPN data', async () => {
        ...
        item._order = (
          await getRepository(RoutingRuleToOpenVPN).findOneOrFail({
            where: {
              routingRuleId: fwc.routingRules.get('routing-rule-1').id,
              openVPNId: item.id,
            },
      ...
      it('should include OpenVPN Prefix data', async () => {
        ...
        item.firewall_name = fwc.firewall.name;
        item._order = (
          await getRepository(RoutingRuleToOpenVPNPrefix).findOneOrFail({
            where: {
              routingRuleId: fwc.routingRules.get('routing-rule-1').id,
      ...
      it('should include mark data', async () => {
        ...
        item.firewall_name = fwc.firewall.name;
        item._order = (
          await getRepository(RoutingRuleToMark).findOneOrFail({
            where: {
              routingRuleId: fwc.routingRules.get('routing-rule-1').id,
              markId: item.id,
            },
    ...
    describe('Into group', () => {
      ...
      it('should include group', async () => {
        ...
        item._order = (
          await getRepository(RoutingRuleToIPObjGroup).findOneOrFail({
            where: {
