...
describe(HAProxyRuleService.name, () => {
    ...
    describe('store', () => {
        ...
        it('should correctly set the rule_order', async () => {
            ...
            const getLastHAProxyRuleInFirewallStub = sinon.stub(service['_repository'], 'getLastHAProxyRuleInFirewall').resolves(expected);
    ...
    describe('copy', () => {
        ...
        beforeEach(async () => {
            ...
            getLastHAProxyRuleInFirewallStub = sinon.stub(service['_repository'], 'getLastHAProxyRuleInFirewall').resolves(haproxyRule);
    ...
    describe('update', () => {
        ...
        it('should update ipObjIds correctly', async () => {
            ...
            const result = await service.update(haproxyRule.id, { ipObjIds } as Partial<ICreateHAProxyRule>);
