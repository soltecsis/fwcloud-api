...
describe(describeName('PolicyRuleRepository Unit tests'), () => {
    ...
    describe('updateActive()', () => {
        ...
        it('should update the policyRule active flag', async () => {
            let policyRule: PolicyRule = await PolicyRule.save(PolicyRule.create({
                rule_order: 1,
                action: 1,
                active: 0,
                special: 0
            ...
            const result: PolicyRule = await getCustomRepository(PolicyRuleRepository).updateActive(policyRule, 1);
        ...
        it('should update multiple policyRule active flag', async () => {
            ...
            const result: Array<PolicyRule> = await getCustomRepository(PolicyRuleRepository).updateActive(policyRules, 1);
        ...
        it('should not update a policyRule active flag if is an special rule', async () => {
            const policyRule: PolicyRule = await PolicyRule.save(PolicyRule.create({
                rule_order: 1,
                action: 1,
                active: 0,
                special: 1
            ...
            const result: Array<PolicyRule> = await getCustomRepository(PolicyRuleRepository).updateActive([policyRule], 1);
    ...
    describe('assignGroup()', () => {
        ...
        it('should change the policy rule group', async () => {
            const policyGroupOld: PolicyGroup = await PolicyGroup.save(PolicyGroup.create({
                name: 'groupOld',
            ...
            const policyGroupNew: PolicyGroup = await PolicyGroup.save(PolicyGroup.create({
                name: 'groupNew',
            ...
            const result = await getCustomRepository(PolicyRuleRepository).assignToGroup(policyRule, policyGroupNew);
        ...
        it('should change multiple policy rule group', async () => {
            ...
            let policyRule2: PolicyRule = await PolicyRule.save(PolicyRule.create({
                rule_order: 1,
                policyGroupId: policyGroupOld.id,
                action: 1,
                firewall: policyGroupOld.firewall
            ...
            const result = await getCustomRepository(PolicyRuleRepository).assignToGroup([policyRule, policyRule2], policyGroupNew);
        ...
        it('should not change a group if the rule firewall is not the same as the group firewall', async () => {
            ...
            await getCustomRepository(PolicyRuleRepository).assignToGroup([policyRule], policyGroupNew);
        ...
        it('should unassign the group if is called with null', async () => {
            ...
            await getCustomRepository(PolicyRuleRepository).assignToGroup([policyRule], null);
    ...
    describe('updateStyle()', () => {
        it('should update the style', async () => {
            ...
            const result = await getCustomRepository(PolicyRuleRepository).updateStyle(policyRule, "newStyle");
        ...
        it('should update multiple policyRule styles', async () => {
            ...
            const result = await getCustomRepository(PolicyRuleRepository).updateStyle(policyRules, "newStyle");
