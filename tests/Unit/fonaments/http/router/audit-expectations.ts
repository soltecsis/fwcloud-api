...
export const auditRouteExpectationManifest: AuditRouteExpectationManifest = {
  ...
  'POST /policy/shared-rules': { audited: true },
  'POST /policy/shared-rules/apply': { audited: true },
  'POST /policy/shared-rules/rule': { audited: true },
  ...
  'PUT /policy/shared-rules': { audited: true },
  'PUT /policy/shared-rules/applications/get': {
    audited: false,
    notes: 'Read-style operation over a mutating HTTP verb.',
  },
  'PUT /policy/shared-rules/apply': { audited: true },
  'PUT /policy/shared-rules/del': { audited: true },
  'PUT /policy/shared-rules/get': {
    audited: false,
    notes: 'Read-style operation over a mutating HTTP verb.',
  },
  'PUT /policy/shared-rules/rule': { audited: true },
  'PUT /policy/shared-rules/rule/del': { audited: true },
  'PUT /policy/shared-rules/rules/get': {
    audited: false,
    notes: 'Read-style operation over a mutating HTTP verb.',
  },
  'PUT /policy/shared-rules/unapply': { audited: true },
